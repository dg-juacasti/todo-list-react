...
describe("TodoList App tests", () => {
  ...
  it("Should update a todo, description and date", async () => {
    ...
    render(<MemoryRouter initialEntries={[`edit/41`]}>
      <Route path={'edit/:id'}>
  ...
  it("Should delete a todo", async () => {
    ...
    render(<Todo todo={ {
      ...
      id_author: 1,
      status: 0,
    }} isEven={false} deleteTodo={deleteTodoMock}/> );
  ...
  it("Should update the todo status ", async () => {
    ...
    render(<Todo todo={ {
      ...
      id_author: 1,
      status: 0,
    }} isEven={false} toggleComplete={checkTodoMock}/> );
  ...
  render(<TodoList setList={()=>{}} todoList={[{
    description: "Test",
    finish_at: new Date().toString(),
    id: 1,
    id_author: 14,
